...
interface DiscordContactButtonProps {
  userLogin: string;
}

export function DiscordContactButton({ userLogin }: DiscordContactButtonProps) {
  ...
  return (
    <button
      ...
      onMouseLeave={(e) => {
        ...
        (e.currentTarget as HTMLElement).style.borderColor = "hsl(var(--foreground) / 0.1)";
      }}
    >
      <svg
        width="18"
